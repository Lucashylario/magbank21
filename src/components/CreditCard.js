...
import { faMobile, faShoppingCart, faWallet, faCreditCard } from '@fortawesome/free-solid-svg-icons';
        ...
        <Row>
            <Col xs={12} lg={7} className='mb-5 mb-lg-0 px-5 px-lg-0'>
                ...
                <Row>
                    ...
                    <Col xs={12} lg={6} className='mb-4'>
                        <IconText icon={faShoppingCart} size={2}  color='#f05656' className='h5 text-muted'>
                            Pagamentos Online
                        </IconText>
                    </Col>
                    <Col xs={12} lg={6} className='mb-4'>
